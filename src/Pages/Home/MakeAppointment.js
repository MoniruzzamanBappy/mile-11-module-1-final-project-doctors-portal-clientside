...
const MakeAppointment = () => {
  return (
    ...
    className="justify-center items-center flex px-12">
      ...
      <div className="flex-1 ">
        ...
        <button className="btn border-primary text-white bg-gradient-to-r from-secondary mt-6 to-primary">Get Started</button>
      </div>
    </section>
  );
};
